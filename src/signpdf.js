...
import PDFArrayCustom from "./pdfcustom";

export default class SignPDF {
  constructor(pdfFile, certFile, options) {
  ...
  async signPDF() {
    ...
    newPDF = signer.sign(newPDF, this.certificate, this.options);
